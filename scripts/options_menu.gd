...
func _ready() -> void:
	...
	$"Fullscreen Button".button_pressed = config.get_value("Options","isFullscreen")
...
func _on_fullscreen_button_toggled(toggled_on: bool) -> void:
	...
	#checks if the checkbox is enabled and then either fullscreens or windows the screen
	if toggled_on == true:
